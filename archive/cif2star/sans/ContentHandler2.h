/*
 * $Id: ContentHandler2.h 73 2006-08-09 18:38:31Z dmaziuk $
 *
 * This software is copyright (c) 2006 Board of Regents, University of Wisconsin.
 * All Rights Reserved.
 *
 */
#ifndef _CONTENT_HANDLER2_H_
#define _CONTENT_HANDLER2_H_
 ...
 * contains callback signatures for SansParser2. User must create a
...
class ContentHandler2 {
  public:
     ...
     * \brief Tag.
     *
     * Called when the parser encounters a tag.
     * 
     * \param line line number
     * \param name tag name, including leading underscore
     * \return "stop" flag: if true, parser will stop and return.
     */
    virtual bool tag( int line, const std::string& name ) = 0;
    /**
     * \brief Value.
     *
     ...
     * \see STARLexer::Types
     */
    virtual bool value( int line, const std::string& val, STARLexer::Types delim ) = 0;
    /**
     * To keep gcc happy.
     */
    virtual ~ContentHandler2() {}
};

#endif // CONTENT_HANDLER2_H
